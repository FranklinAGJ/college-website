                        ...
                        <div class="card h-100 shadow-sm animate-on-scroll fade-in-element"
                            ...
                            <div class="card-body text-center">
                                <div class="faculty-img mb-3">
                                    <?php
                                    $faculty_images = [
                                        'Dr. Nityashree Nadar' => '../images/principal-video-thumbnail.jpg',
                                        'Mrs. Gayatri Venkatachalam' => '../images/science-lab.jpg',
                                        'Mrs. Suchita U. Revankar' => '../images/students-studying.jpg'
                                    ];
                                    $image = isset($faculty_images[$member['name']]) ? $faculty_images[$member['name']] : '../images/campus-courtyard.jpg';
                                    ?>
